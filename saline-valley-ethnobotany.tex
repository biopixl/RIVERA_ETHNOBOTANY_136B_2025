...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{saline_valley_territories.png}
\caption{Indigenous territories of the Saline Valley region showing simplified boundaries for the five groups covered in this report. Boundaries represent approximate traditional territories based on ethnographic sources including \citet{kroeber1925}, \citet{steward1933}, \citet{steward1938}, and \citet{zigmond1981}. Saline Valley occupied a transitional zone where multiple groups converged for salt procurement and seasonal resource exploitation.}
