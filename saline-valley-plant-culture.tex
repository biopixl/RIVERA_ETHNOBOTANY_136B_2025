...
\subsection{Willow (\textit{Salix lasiolepis})}

Arroyo willow, the primary willow of the region, provided one of the most important medicines. The bark contains salicin, a white crystalline glucoside that the body converts to salicylic acid---the original ingredient in aspirin \citep{bocek1984}. Willow bark tea treated headaches, fever, and inflammatory conditions. Branches gathered in fall and dried through the cold winter air yielded bark with optimal salicin content. Beyond medicine, willow's material applications were extensive---basketry, watercraft, tools---and are discussed in the Material Culture section below.
...
\subsection{Willow in Material Culture}

Beyond its medicinal value, arroyo willow (\textit{Salix lasiolepis}) was indispensable to material culture. The flexible young shoots, harvested after the first frost and dried through winter, provided material for diverse applications. Willow withes bound the tule bundles that formed watercraft for navigating Owens Lake and marshlands \citep{bryant1985}. Fish traps and weirs were constructed from willow frames. Children's toys---hoops, balls, dolls---were fashioned from willow, as were musical instruments including rattles and flutes. The long, straight shoots provided foundational warps for coiled baskets, their pliability allowing the tight weaving that made baskets watertight for cooking and storage.

\subsection{Fiber and Cordage}

Joshua tree (\textit{Yucca brevifolia}) provided the strongest plant fibers available in the region. Leaves were soaked, pounded, and the fibers extracted for cordage, nets, sandals, and snares. The roots produced a soap rich in saponins, used for washing hair and hides. Milkweed (\textit{Asclepias} spp.) and Indian hemp (\textit{Apocynum cannabinum}) yielded finer fibers twisted into string for nets and bags. Cattail (\textit{Typha domingensis}) leaves were woven into mats for shelters, bedding, and the outer covering of tule boats.
