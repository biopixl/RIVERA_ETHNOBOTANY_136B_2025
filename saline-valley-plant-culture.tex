...
This document synthesizes ethnobotanical knowledge for the Saline Valley region, where five Indigenous groups---Kawaiisu, Tubatulabal, Newe Sogobia (Western Shoshone), N\"u\"um\"u Wit\"u (Eastern Mono), and N\"u\"um\"u (Northern Paiute)---developed sophisticated relationships with the desert flora over millennia. Their knowledge systems integrated food procurement, healing practices, ceremonial life, and material production into a unified understanding of the landscape.

\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{saline_valley_territories_geo.png}
\caption{Indigenous territories of the Saline Valley region overlaid on Basin and Range topography. The characteristic north-south trending ranges created distinct ecological zones exploited through seasonal migration.}
...
The Indigenous peoples of the Saline Valley region developed sophisticated social organizations, maintained extensive trade networks, and elaborated rich cosmovisions that gave meaning to their relationship with the natural world. Their languages are distinct although within the Uto-Aztecan family. Social organization followed a gradient of resource availability: ``family'' groups in resource-poor areas and ``band'' groups where abundance permitted larger aggregations. Leadership remained fundamentally egalitarian; shamans (\textit{puagants}) wielded influence through their ability to manipulate \textit{puha} (spiritual power), but coercive political authority was absent.

Seasonal rounds structured the year. During summer months, family groups migrated to communal sites at cooler elevations---Hunter Mountain, the Inyo crest, the White Mountains---where productive harvesting of pi\~{n}on nuts, seeds, roots, and berries supported gatherings of fifty to one hundred people. These summer communes served critical social functions: relatives reacquainted themselves, marriages were arranged, and ceremonial knowledge was transmitted. With the onset of cool weather, groups descended to valley floor villages where mesquite groves and springs provided winter resources. The salt deposits of Saline Valley were collected by the local Timbisha Shoshone and traded with the Owens Valley Paiute for brown-ware pottery, positioning the valley at the center of regional exchange networks.
...
Acorns from California scrub oak (\textit{Quercus berberidifolia}) and canyon live oak (\textit{Q. chrysolepis}) required elaborate processing to render them edible. Bitter polyphenolic tannins interfere with nutrient absorption and protein digestion; removal involves drying acorns for up to a year, pounding the dried nuts into meal using bedrock mortars, and leaching the flour with repeated water applications. Acorns with higher tannin content required leaching for up to two weeks. Processing temperatures below 150\textdegree F preserve a starch analogous to gluten, enabling the meal to be formed into cakes for baking \citep{bainbridge1986}. Both acorns and pi\~{n}on nuts were stored in elevated granaries lined with aromatic plants such as California mugwort (\textit{Artemisia douglasiana}) to repel insects.
...
Seeds formed the dietary foundation across the region, their diversity providing security against the failure of any single crop. Chia (\textit{Salvia columbariae}) seeds were parched and ground into a mucilaginous flour rich in omega-3 fatty acids. Dock (\textit{Rumex} spp.) seeds were ground into porridge. Indian ricegrass (\textit{Achnatherum hymenoides})---one of the most important seed foods of the Great Basin---thrived on the sandy soils of Saline Valley; its seeds were parched, winnowed, and ground into flour or added whole to stews. Saltbush (\textit{Atriplex confertifolia}) provided both edible seeds and leaves that served as a salt substitute, abundant on the alkaline valley floors.
...
The starchy roots of biscuitroot (\textit{Lomatium utriculatum}) were dug with hardwood digging sticks and eaten raw, roasted, or dried for storage. Cattail (\textit{Typha} spp.) provided multiple resources from a single plant: the starchy rhizomes were roasted or dried and ground into flour; the protein-rich pollen was collected in spring and used as flour; the leaves were woven into mats, shelters, and the tule boats that navigated Owens Lake. Young shoots of cattail were eaten raw as a vegetable.

Yucca (\textit{Yucca schidigera}, \textit{Y. brevifolia}) flower stalks were roasted in earth ovens, yielding a sweet, fibrous food. The fruit was also eaten, and the plant's utility extended far beyond subsistence into material culture.
...
\subsection{White Sage (\textit{Salvia apiana})}

White sage was burned for smudging---the aromatic smoke purifying spaces, objects, and individuals before ceremonies. The seeds were also eaten, ground into flour or added to pinole. White sage remains central to Indigenous ceremonial practice today, though commercial overharvesting has stressed wild populations.
...
Preferred basketry materials varied by tradition and application. Willow (\textit{Salix} spp.) provided flexible warp rods. Deergrass (\textit{Muhlenbergia rigens}) offered foundation bundles for coiled baskets. Redbud (\textit{Cercis occidentalis}) bark contributed red-brown design elements, while the white root fibers of sedge (\textit{Carex} spp.) created contrasting patterns.
...
Yucca (\textit{Yucca} spp.) provided the strongest plant fibers available. Leaves were soaked, pounded, and the fibers extracted for cordage, nets, sandals, and snares. The roots produced a soap rich in saponins, used for washing hair and hides. Milkweed (\textit{Asclepias} spp.) and dogbane (\textit{Apocynum cannabinum}) yielded finer fibers twisted into string for nets and bags.
