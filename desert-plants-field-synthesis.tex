...
\textit{Field observation}: Identify valley oak (\textit{Quercus lobata}) by deeply lobed leaves and elongated acorns, or interior live oak (\textit{Q. wislizeni}) by holly-like evergreen leaves. Examine bedrock mortars where present---the smooth, cup-shaped depressions in granite were created through generations of grinding. The depth and polish of these mortars indicate intensive, long-term use at specific processing sites.
